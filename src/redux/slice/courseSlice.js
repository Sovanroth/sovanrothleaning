...
export const getCoursesData = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `sovanrothlearning.c7wbcdohxr1v.ap-southeast-1.rds.amazonaws.com/course/get-all-courses`
    );
    if (response?.data) {
...
export const getOneData = (param) => async (dispatch) => {
  ...
  try {
    const respone = await axios.get(
      `sovanrothlearning.c7wbcdohxr1v.ap-southeast-1.rds.amazonaws.com/course/get-course-with-video/${param}`
    );
    if (respone?.data) {
      // dispatch(getone)
...
export const deleteCourse = (param) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `sovanrothlearning.c7wbcdohxr1v.ap-southeast-1.rds.amazonaws.com/course/delete-course/${param}`
    );
    return response;
  } catch (error) {
    console.log(error);
