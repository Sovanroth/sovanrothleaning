...
export default function DeleteCommentModal({ onClose, commentId, courseId }) {
  ...
  const handleDeleteComment = async () => {
    ...
    try {
      const response = await dispatch(deleteComemet(commentId));
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure that you want to delete this comment? The
                        deleted resource will be permanently removed. This
